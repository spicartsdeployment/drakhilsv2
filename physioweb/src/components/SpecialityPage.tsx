...
export function SpecialityPage({ data }: SpecialityPageProps) {
  ...
  // Generic FAQs for all speciality pages
  const genericFAQs = [
    {
      question: 'What Qualifications Do Your Healthcare Professionals Have?',
      answer: 'Our healthcare professionals hold advanced degrees and certifications in their respective fields. They undergo continuous professional development and training to stay current with the latest treatment techniques and evidence-based practices.'
    },
    {
      question: 'How Does This Specialist Approach Differ From Others?',
      answer: 'Our specialists use a holistic, patient-centered approach that combines advanced clinical expertise with personalized care. We focus on understanding your unique needs and goals to create customized treatment plans that deliver optimal outcomes.'
    },
    {
      question: 'How Long Does A Typical Consultation Last?',
      answer: 'Initial consultations typically last 60-90 minutes to allow for comprehensive assessment and treatment planning. Follow-up sessions are usually 45-60 minutes, depending on your specific needs and treatment plan.'
    },
    {
      question: 'Will I See The Same Specialist For All Sessions?',
      answer: 'Yes, continuity of care is important to us. You will work with the same specialist throughout your treatment journey to ensure consistent, personalized care and to build a strong therapeutic relationship.'
    },
    {
      question: 'Are These Services Covered By Insurance?',
      answer: 'Many insurance plans cover our professional services. We recommend checking with your insurance provider regarding coverage details, co-pays, and authorization requirements. Our staff can assist you with insurance verification and claims.'
    },
    {
      question: 'Can I Choose A Specific Specialist To Work With?',
      answer: 'Absolutely! We encourage you to choose a specialist who best fits your needs and preferences. Our team can help match you with the right professional based on your condition, goals, and personal preferences.'
    }
  ];
            ...
            <div className="lg:col-span-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8" style={{ marginTop: '48px' }}>
                ...
                <div>
                  ...
                  >
                    Our team of healthcare professionals is dedicated to providing exceptional care tailored to your unique needs:
                  </p>
              ...
              <div style={{ marginTop: '48px', maxWidth: '800px' }}>
                ...
                >
                  Understanding your healthcare options is essential for making informed decisions. Our specialists are committed to providing transparent, comprehensive care that addresses your concerns and helps you achieve your health goals.
                </p>
